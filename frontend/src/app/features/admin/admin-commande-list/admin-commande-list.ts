...
@Component({
  ...
  templateUrl: './admin-commande-list.html',
  styleUrl: './admin-commande-list.css'
})
export class AdminCommandeList implements OnInit {
  ...
  setFiltre(statut: CommandeStatut | 'TOUS') {
